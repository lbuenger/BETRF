...
def main(argv):
    ...
    for iteration in range(0,1):
        ...
        exp_data.write("Feature injection: "+str(feature_inj)+"\n")
            ...
            for est in estims:
                ...
                for ber in bers:
                    for tree in clf.estimators_:
                        ...
                        tree.tree_.bit_error_rate_featval = 0
                        ...
                        if feature_inj == 1:
                            ...
                            tree.tree_.bit_flip_injection_featval = 1
                            tree.tree_.bit_flip_injection_featval_floatInt = 1
                            tree.tree_.nr_feature_val = 8
